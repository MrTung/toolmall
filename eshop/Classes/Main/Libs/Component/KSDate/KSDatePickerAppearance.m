...
- (void)defultValue
{
    ...
    _headerText = @"请选择日期";
//    _headerTextColor = [UIColor whiteColor]; 原来数据
    _headerTextFont = [UIFont systemFontOfSize:15];
//    _headerBackgroundColor = [UIColor colorWithRed:45/255. green:54/255. blue:62/255. alpha:1]; 原来数据
    _headerBackgroundColor = [UIColor lightGrayColor];
