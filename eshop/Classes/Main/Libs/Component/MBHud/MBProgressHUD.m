...
static const CGFloat MBDefaultLabelFontSize = 13.f;
...
- (void)updateConstraints {
    ...
    CGFloat doubleMargin = margin*1.3;
    NSMutableArray *bezelConstraints = [NSMutableArray array];
//    NSDictionary *metrics = @{@"margin": @(margin)};
    NSDictionary *metrics = [NSDictionary dictionaryWithObjectsAndKeys:@(margin),@"margin", @(doubleMargin),@"doubleMargin", nil];
    ...
    [sideConstraints addObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(>=doubleMargin)-[bezel]-(>=doubleMargin)-|" options:0 metrics:metrics views:NSDictionaryOfVariableBindings(bezel)]];
    ...
    [subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger idx, BOOL *stop) {
        ...
        [bezelConstraints addObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(>=doubleMargin)-[view]-(>=doubleMargin)-|" options:0 metrics:metrics views:NSDictionaryOfVariableBindings(view)]];
        // Element spacing
        if (idx == 0) {
...
- (id)init {
    return [self initWithFrame:CGRectMake(0.f, 0.f, 25.f, 25.f)];
}
...
//        _progressTintColor = lightGrayColorSelf;
//        _backgroundTintColor = lightGrayColorSelf;
    }
    return self;
}
...
//            _color = [[UIColor blackColor] colorWithAlphaComponent:0.8];
        ...
        _color = [[UIColor darkGrayColor] colorWithAlphaComponent:0.8];
