...
@property (nonatomic, strong)   UIScrollView    *navgationTabBar;      // 滚动视图
@property (nonatomic, strong)   NSArray         *itemsWidth;           // an array of items' width
...
@property (nonatomic, assign) BOOL hasAllBtn;
