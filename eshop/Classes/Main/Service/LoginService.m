...
- (void)loginWithQQ:(NSString *)openId nickName:(NSString *)nickName cartId:(long)cartId success:(void (^)(BaseModel*responseObj))success{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:[NSDate date] forKey:api_qqlogin];
    [[NSUserDefaults standardUserDefaults] synchronize];
    [super request:api_qqlogin params:params responseObj:respobj showLoading:YES success:success];
...
- (void)loginWithWX:(NSString *)openId nickName:(NSString *)nickName cartId:(long)cartId accessToken:(NSString *)accessToken success:(void (^)(BaseModel*responseObj))success{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:[NSDate date] forKey:api_wxlogin];
    [[NSUserDefaults standardUserDefaults] synchronize];
    [super request:api_wxlogin params:params responseObj:respobj showLoading:YES success:success];
